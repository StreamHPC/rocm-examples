...
The examples in this subdirectory showcase the functionality of the [rocSPARSE](https://github.com/ROCm/rocSPARSE) library. The examples build on both Linux and Windows for the ROCm (AMD GPU) backend.
